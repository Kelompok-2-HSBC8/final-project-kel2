...
function ProfilePage() {
    ...
    return (
        <div className="w-full flex flex-col border overflow-x-hidden min-h-screen">
            ...
            <div className="">
                <img
                    className="max-h-[15rem] mt-10 bg-cover cursor-pointer filter hover:blur-[2px] -z-[999999] min-w-full"
                    src="https://c4.wallpaperflare.com/wallpaper/1020/457/119/digital-art-lofi-night-crescent-moon-silhouette-hd-wallpaper-preview.jpg"
                    alt="bg"
                />
                <div className="flex flex-row justify-between">
                    <img
                        className="relative bottom-20 mx-5 min-w-[10rem] min-h-[9rem] bg-cover rounded-full border-4 border-white cursor-pointer hover:blur-[2px] filter max-h-[10rem]"
                        src="https://i.pinimg.com/originals/2a/e1/ad/2ae1ad2e6ad8f03731fcafa69f62791e.jpg"
                        alt="profile"
                    />
            ...
            <div className="flex flex-col p-3 relative bottom-20">
                <h2 className="font-bold text-2xl">Kelompok 2</h2>
                <h5 className="text-gray-500 font-[100]">@kel2hsbc8</h5>
            </div>
            ...
            <div className="flex flex-row p-3 relative bottom-[6.4rem]">
                ...
                <div className="flex flex-row justify-center items-center mr-4">
                    <span className="ml-1 font-bold">256 JT</span>
                    <span className="font-[300] mx-2 text-gray-500">
                        Pengikut
                    </span>
                </div>
                ...
                <div className="flex flex-row p-4 w-full border border-l-0 border-r-0 hover:bg-gray-100 cursor-pointer">
                    ...
                    <div className="flex flex-col mx-3">
                        <div className="flex flex-row justify-center items-center">
                            <h2 className="font-bold">Kelompok 2</h2>
